...
🚀 Live Links
Web Interface: https://insurance-prediction-pi.vercel.app/

Predictive API: https://wissalselmane-insurance-prediction-api.hf.space
...
The engine of this project is a Random Forest Regressor, meticulously developed in the InsurancePrediction.ipynb notebook. This model was selected for its superior ability to handle the complexities of insurance data:
...
├── trainig_model # Data Science notebook (EDA & Model Training)
└── README.md                 # Project documentation
📊 Model Evaluation Summary
As demonstrated in the final stages of the notebook, the model was validated using rigorous metrics to ensure reliability:

Key Metrics: Root Mean Squared Error (RMSE), Mean Absolute Error (MAE), and R² Score.

Residual Analysis: Visualizations of residuals and "Actual vs. Predicted" plots confirm that the model handles complex feature interactions effectively across different demographics.
